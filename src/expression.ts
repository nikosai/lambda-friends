...
export class Application extends Expression {
  ...
  public getUnTypedRedex(
    ...
    const searchL = () => {
      let ret = this.left.getUnTypedRedex(
        etaAllowed,
        rightmost,
        innermost,
        weak,
    ...
    const searchR = () => {
      let ret = this.right.getUnTypedRedex(
        etaAllowed,
        rightmost,
        innermost,
        weak,
...
export class Let extends Expression {
  ...
  public getEquations(
    ...
    let nextR = this.right.getEquations(
...
export class Case extends Expression {
  ...
  public getEquations(
    ...
    let nextE = this.ifElse.getEquations(
